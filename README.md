...
|-----------|------------|-------------|
| ![Schematic]([images/Circuit Schematic.png](https://github.com/BEEMB/DIY-Battery-Spot-Welder/blob/main/Images/Circuit%20Schematic.png)) | ![PCB](images/PCB 3D Render.png) | ![Build](images/Final Assembly view.JPG) |
